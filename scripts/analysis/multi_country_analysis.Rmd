...
```{r dfs, include=FALSE}
ches <- read.csv('C:/Users/samtg/github/subnational_inequality/data/raw/parties/ex_ches.csv')
ches_crosswalk<-read.csv('C:/Users/samtg/github/subnational_inequality/data/raw/crosswalks/ches_pfid_manifesto.csv')
```
...
```{r}
soc_panel%>%
  filter(region == 'abruzzo')%>%
  select(country_name,region,year,z_perc_socdem)
```
